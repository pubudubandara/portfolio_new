    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section id="hero" className="min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center ">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-4">Pubudu Bandara</h1>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              <p className="text-lg text-muted-foreground mb-6 leading-relaxed">
                I'm a passionate Information Technology student at the University of Moratuwa, currently pursuing my BSc
                (Hons) in IT. I have a strong interest in modern web development technologies and artificial
                intelligence.
              </p>
              <p className="text-lg text-muted-foreground mb-6 leading-relaxed">
                My journey in technology has led me to specialize in the MERN stack, where I enjoy building full-stack
                applications that solve real-world problems. I'm always eager to learn new technologies and take on
            ...
            <Card className="shadow-lg">
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <p className="text-muted-foreground">BSc (Hons) in Information Technology</p>
      ...
      <footer className="py-8 px-4 sm:px-6 lg:px-8 border-t">
        <div className="max-w-4xl mx-auto text-center">
          <p className="text-muted-foreground">© 2024 Pubudu Bandara. All rights reserved.</p>
        </div>
      </footer>
    </div>
  )
