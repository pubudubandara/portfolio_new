    ...
    >
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        {skills.length === 0 ? (
          ...
          <div ref={skillsRef} className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 xl:grid-cols-8 gap-6">
            {skills.map((skill, index) => (
              <Card
                key={skill._id}
                className="group relative overflow-hidden border border-gray-200/80 dark:border-gray-700/50 bg-white/95 dark:bg-slate-800/95 backdrop-blur-sm shadow-lg hover:shadow-2xl hover:shadow-blue-500/20 transition-all duration-500 ease-out hover:-translate-y-2 hover:scale-[1.05] cursor-pointer"
